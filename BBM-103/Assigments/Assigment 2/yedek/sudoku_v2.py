...
# print steps to test program
# 
# Since we don't need to use the terminal, 
# I put it in the comment line, 
# in case it needs to be used for testing.
#
...
# finds possible values for each value
def possibilityCaunter(event,R,C):
    
   # The sets to be used have been defined.
   # why set because 
   # because it keeps the same data only once.
   ...
   # This function finds possible values that are impossible to happen
